...
class _EditState extends State<Edit> {
  ...
  void initState() {
    ...
    _markController.text = widget.customer.mark;

    _gender = widget.customer.gender;
    _birthday = DateTime.parse(widget.customer.birthday);
  }

  void _updateCustomer(String name, String age, gender, birthday, String phone,
